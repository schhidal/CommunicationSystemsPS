...
% -- Perform High side injection Downconversion --
disp('Performing High-side injection...');
f_lo_high = fc + f_if; % 1000+200 = 1200 Hz
c_lo = cos(2*pi*f_lo_high*t);  % 1200 Hz local oscillator
...
subplot(2,1,2);
title('1(d) Spectrum after Low-side Injection (F_{LO} = 1200 Hz)');
