% --- MATLAB/Octave Script for Notch Filter: Part (d) ---
...
disp('--- Part (d): Cauer (Elliptic) Filter Method ---');
...
% --- 4. Design the Notch Filter (using 'ellip') ---
disp('Designing the 300 Hz Cauer (Elliptic) Notch Filter...');
...
% Design the filter using ellip
[b, a] = ellip(N_order, Rp, Rs, Wn, 'stop');
% --- End of modification ---
...
figure; % Figure 2
freqz(b, a, 1024, fs);
title('(d) Cauer (Elliptic) Notch Filter Response (Order=6, Rp=1, Rs=40)');
